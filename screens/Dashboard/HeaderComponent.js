...
const HeaderComponent = ({ currentWeek, message, dateRange, onPreviousWeek, onNextWeek }) => {
  return (
      <View style={globalStyles.headerContainer}>

        {/* Left Icon for navigating to previous week */}
        <TouchableOpacity onPress={onPreviousWeek} style={globalStyles.iconLeft}>
          <Icon name="arrow-back" size={30} color={globalStyles.iconColor.color} />
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={onNextWeek} style={globalStyles.iconRight}>
          <Icon name="arrow-forward" size={30} color={globalStyles.iconColor.color} />
        </TouchableOpacity>
